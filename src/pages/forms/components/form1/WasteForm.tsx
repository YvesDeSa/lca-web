...
const WasteForm: React.FC = () => (
  <FormContainer>
    ...
    <InputContainer>
      <Label htmlFor="quantityWaste">Quantity of solid waste generated</Label>
      <Input type="number" id="quantityWaste" placeholder="Enter quantity" />
    </InputContainer>
    <InputContainer>
    ...
    <InputContainer>
      <Label htmlFor="distanceToDam">Distance between tailings dam and the industry</Label>
